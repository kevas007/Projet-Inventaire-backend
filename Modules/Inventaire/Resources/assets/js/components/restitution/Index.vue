        ...
        <v-container class="mx-auto text-center">
            ...
            >
                ...
                >
                    ...
                    <div v-if="validationSuccess" class="validation-success">Matériel trouvé !</div>

                    <div
                        v-if="validationFailure"
                        class="validation-failure"
                    >Le Matériel indisponible !</div>

                    <div v-if="validationPending" class="validation-pending">Scan en cours...</div>
                </qrcode-stream>
                <v-text-field name="degats" v-if="materiel" label="Notez les dégâts"></v-text-field>
