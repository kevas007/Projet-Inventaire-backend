      ...
      <template v-slot:default>
        ...
        <tbody>
          <tr v-for="item in contrats" :key="item.id">
            ...
            <td v-if="item.emprunteur">
              Emprunteur {{ item.emprunteur.nom }} {{ item.emprunteur.prenom }}
            </td>
            <td v-else-if="item.team">
              {{ item.team.lastname }} {{ item.team.firstname }}
            </td>
            ...
            <td>
              <div>
                <v-btn
                  :href="'/inventaire/contrat/' + item.id + '/edit'"
                  color="success"
                >
                  <!-- <script src="https://cdn.lordicon.com/lusqsztk.js"></script> -->
